...
public class MSI extends ScannerSettingsFragment {

    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        addPreferencesFromResource(R.xml.settings_sym_msi);
        PreferenceManager.setDefaultValues(MainActivity.getInstance(), R.xml.settings_sym_msi, false);
        ...
        EditTextPreference min = this.findPreference(getString(R.string.setting_MSI_Length_Parameter30));
        EditTextPreference max = this.findPreference(getString(R.string.setting_MSI_Length_Parameter31));
        if (min != null) {
    ...
    public void onResume() {
        ...
        MainActivity.getInstance().setTitle(R.string.config_MSI);
    }
