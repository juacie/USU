...
public class Code_128 extends ScannerSettingsFragment {

    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
       Logger.debug("Code_128 onCreatePreferences");
        addPreferencesFromResource(R.xml.settings_sym_code_128);
        PreferenceManager.setDefaultValues(MainActivity.getInstance(), R.xml.settings_sym_code_128, false);
        ...
        EditTextPreference min = this.findPreference(getString(R.string.setting_Code_128_Length_Parameter209));
        EditTextPreference max = this.findPreference(getString(R.string.setting_Code_128_Length_Parameter210));
        if (min != null) {
    ...
    public void onResume() {
        ...
        MainActivity.getInstance().setTitle(R.string.setting_Code_128);
    }
