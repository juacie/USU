...
package com.unitech.scanner.utility.weight.floatingview;
...
public class FloatingViewManager implements ScreenChangedListener, View.OnTouchListener, TrashViewListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        // 如果即使未處於移動狀態也未提供移動許可，則不執行任何操作（對應於ACTION_MOVE在旋轉後立即出現並且FloatingView消失的現象）
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (mFloatingViewListener != null) {
                mFloatingViewListener.onTouchScanStart();
            }
        }
        // 移動
            ...
            // 如果它們重疊，則使FloatingView跟隨TrashView
//            if (isIntersecting) {
...
//            }
            ...
            if (mFloatingViewListener != null) {
                mFloatingViewListener.onTouchScanEnd();
