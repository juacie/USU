...
public class Discrete2of5 extends ScannerSettingsFragment {
    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        addPreferencesFromResource(R.xml.settings_sym_discrete2of5);
        PreferenceManager.setDefaultValues(MainActivity.getInstance(), R.xml.settings_sym_discrete2of5, false);
        ...
        EditTextPreference min = this.findPreference(getString(R.string.setting_Discrete_2_of_5_Length_Parameter20));
        EditTextPreference max = this.findPreference(getString(R.string.setting_Discrete_2_of_5_Length_Parameter21));
        if (min != null) {
    ...
    public void onResume() {
        ...
        MainActivity.getInstance().setTitle(R.string.setting_Discrete_2_of_5);
    }
