...
public class GS1_DataBar extends ScannerSettingsFragment {
    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        addPreferencesFromResource(R.xml.settings_sym_gs1_data_bar);
        PreferenceManager.setDefaultValues(MainActivity.getInstance(), R.xml.settings_sym_gs1_data_bar, false);
    ...
    public void onResume() {
        ...
        MainActivity.getInstance().setTitle(R.string.config_GS1_DataBar);
    }
