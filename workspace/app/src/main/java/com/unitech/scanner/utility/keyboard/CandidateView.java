...
public class CandidateView extends View {
    ...
    private int mTouchX = KeyboardConfig.OUT_OF_BOUNDS;
    ...
    private int[] mWordWidth = new int[KeyboardConfig.MAX_SUGGESTIONS];
    private int[] mWordX = new int[KeyboardConfig.MAX_SUGGESTIONS];
    ...
    private void scrollToTarget() {
        ...
        if (mTargetScrollX > sx) {
            sx += KeyboardConfig.SCROLL_PIXELS;
    ...
    public void clear() {
        ...
        mTouchX = KeyboardConfig.OUT_OF_BOUNDS;
        mSelectedIndex = -1;
        invalidate();
    }
