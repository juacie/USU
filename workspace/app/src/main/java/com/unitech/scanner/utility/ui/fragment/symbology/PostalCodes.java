...
public class PostalCodes extends ScannerSettingsFragment {
    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        addPreferencesFromResource(R.xml.settings_sym_postal_codes);
        PreferenceManager.setDefaultValues(MainActivity.getInstance(), R.xml.settings_sym_postal_codes, false);
    ...
    public void onResume() {
        ...
        MainActivity.getInstance().setTitle(R.string.config_PostalCodes);
    }
