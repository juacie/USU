...
public class Upc_ean_jan extends ScannerSettingsFragment {

    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        addPreferencesFromResource(R.xml.settings_sym_upc_ean_jan);
        PreferenceManager.setDefaultValues(MainActivity.getInstance(), R.xml.settings_sym_upc_ean_jan, false);
    ...
    public void onResume() {
        ...
        MainActivity.getInstance().setTitle(R.string.config_UpcEanJan);
    }
