...
public class LatinKeyboard extends Keyboard {
    ...
    void ShiftKeyLock(Resources res, Resources.Theme theme,boolean lock){
        if(mShiftKey==null)return;
        if(lock){
            mShiftKey.icon = res.getDrawable(R.drawable.keyboard_capslock,theme);
        }else{
            mShiftKey.icon = res.getDrawable(R.drawable.keyboard_arrowup,theme);
        }
    }
     ...
     */
    @SuppressLint("UseCompatLoadingForDrawables")
    void setImeOptions(Resources res, Resources.Theme theme, int options) {
        if (mEnterKey == null) {
            return;
        }
        ...
        switch (options&(EditorInfo.IME_MASK_ACTION| EditorInfo.IME_FLAG_NO_ENTER_ACTION)) {
            ...
            case EditorInfo.IME_ACTION_SEARCH:
                mEnterKey.icon = res.getDrawable(R.drawable.keyboard_search,theme);
            ...
            case EditorInfo.IME_ACTION_SEND:
                ...
                break;
            default:
                mEnterKey.icon = res.getDrawable(R.drawable.keyboard_enter,theme);
                mEnterKey.label = null;
                break;
        }
    }
