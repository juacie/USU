...
public class Code_11 extends ScannerSettingsFragment {
    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        addPreferencesFromResource(R.xml.settings_sym_code_11);
        PreferenceManager.setDefaultValues(MainActivity.getInstance(), R.xml.settings_sym_code_11, false);
        ...
        EditTextPreference min = findPreference(getString(R.string.setting_Code_11_Length_Parameter28));
        EditTextPreference max = findPreference(getString(R.string.setting_Code_11_Length_Parameter29));
        if (min != null) {
    ...
    public void onResume() {
        ...
        MainActivity.getInstance().setTitle(R.string.config_Code11);
    }
