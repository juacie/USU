...
public class Matrix_2_of_5 extends ScannerSettingsFragment {
    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        addPreferencesFromResource(R.xml.settings_sym_matrix_2_of_5);
        PreferenceManager.setDefaultValues(MainActivity.getInstance(), R.xml.settings_sym_matrix_2_of_5, false);
        ...
        EditTextPreference min = this.findPreference(getString(R.string.setting_Matrix_2_of_5_Length_Parameter619));
        EditTextPreference max = this.findPreference(getString(R.string.setting_Matrix_2_of_5_Length_Parameter620));
        if (min != null) {
    ...
    public void onResume() {
        ...
        MainActivity.getInstance().setTitle(R.string.config_Matrix_2_of_5);
    }
